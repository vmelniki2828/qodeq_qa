                  ...
                  <InfoCard theme={theme}>
                    ...
                    <InfoCardContent>
                      <InfoItem>
                        ...
                        <InfoValue theme={theme}>{formatDate(d.created_chat_at || d.created_at)}</InfoValue>
                      </InfoItem>
                      <InfoItem>
                        <InfoLabel theme={theme}>
                          <HiClock size={12} />
                      ...
                      <InfoItem>
                        ...
                        <InfoValue theme={theme}>
                          {d.checked ? <HiCheck size={18} color="#16a34a" /> : <HiXMark size={18} color="#dc2626" />}
                        </InfoValue>
                      </InfoItem>
                    </InfoCardContent>
                  </InfoCard>
                  ...
                  <InfoCard theme={theme}>
                    ...
                    <InfoCardContent>
                      ...
                      <InfoItem>
                        ...
                        <InfoValue theme={theme}>
                          <TagsContainer>
                            {tags.length > 0 ? (
                              tags.map((tag, idx) => (
                                <TagBadge key={idx} theme={theme}>{tag}</TagBadge>
                              ))
                            ) : (
                              '—'
                            )}
                      ...
                      <InfoItem>
                        ...
                        <InfoValue theme={theme}>
                          {d.color ? <ColorSwatch $hex={d.color} /> : '—'}
                        </InfoValue>
                      </InfoItem>
                    </InfoCardContent>
                  </InfoCard>
                            ...
                            {opResults.length > 0 ? (
                              <div>
                                {opResults.map((result, idx) => (
                                  <div key={idx} style={{ marginBottom: '12px', padding: '12px', background: theme.colors.surface, borderRadius: '6px', border: `1px solid ${theme.colors.border}` }}>
                                    <div style={{ fontWeight: 600, color: theme.colors.primary, marginBottom: '8px' }}>
                                      {result.question || result.text || '—'}
                                    </div>
                                    {result.explanation && (
                                      <div style={{ fontSize: '12px', color: theme.colors.secondary, marginTop: '6px' }}>
                                        {result.explanation}
                                      </div>
                                    )}
                                  </div>
