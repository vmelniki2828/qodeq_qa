                ...
                {isPromptVersion && onPromptVersionChange && isEditingPromptVersion ? (
                  <div style={{ marginBottom: '20px' }}>
                    ...
                    {isLoadingPrompts ? (
                      ...
                      <div>
                        <InfoCardLabel theme={theme} style={{ marginBottom: '12px', marginTop: '20px' }}>Выберите вариант:</InfoCardLabel>
                          ...
                          {promptOptions.map((option) => {
                            ...
                            return (
                              <PromptCard
                                ...
                                theme={theme}
                                $selected={isSelected}
                                onClick={() => onPromptVersionChange(option.id)}
                              >
                        ...
                        {(promptVersionId || promptVersionValue) && (
                          <div style={{ marginTop: '16px', display: 'flex', justifyContent: 'flex-end' }}>
                            <SaveLimitButton
                              theme={theme}
                              onClick={() => {
                                const valueToSave = promptVersionId || promptVersionValue;
                                if (valueToSave) {
                                  onPromptVersionChange(valueToSave, true);
                                }
                              }}
                              disabled={isSavingPromptVersion || (!promptVersionId && !promptVersionValue)}
                              title="Сохранить"
                            >
                              <HiCheck size={16} />
                            </SaveLimitButton>
                      ...
                      <div style={{ textAlign: 'center', padding: '20px', color: theme.colors.secondary }}>
                        Нет доступных вариантов для выбранного языка
                      </div>
                    ) : null}
                  </div>
                ) : null}
