...
export const SupportMessagesStatsPage = () => {
    ...
    <Layout>
      <PageContent>
        <OverviewSection theme={theme}>
          <OverviewHeader>
            <OverviewTitle theme={theme}>Support Messages — Statistics</OverviewTitle>
            <OverviewSubtitle theme={theme}>Context- and type-based analytics, usage, and errors.</OverviewSubtitle>
          </OverviewHeader>
          <FiltersContainer>
            <DatePicker
